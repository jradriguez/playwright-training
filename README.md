...
This is the repository from the LinkedIn Learning course - Playwright Essential Training: Abstractions, Fixtures, and Complex Scenarios. 
...
1. To use Playwright, you must have the following installed:
...
6. Utilize the links found in [RESOURCES.MD](RESOURCES.md) for each video.
...
## Link to Course
https://www.linkedin.com/learning/playwright-essential-training-abstractions-fixtures-and-complex-scenarios
